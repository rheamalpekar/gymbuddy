...
def Weight_Loss(age, veg, weight, height):
    ...
    if ( bmi < 16):
        st.write("Acoording to your BMI, you are Severely Underweight")
        clbmi=4
    elif ( bmi >= 16 and bmi < 18.5):
        st.write("Acoording to your BMI, you are Underweight")
        clbmi=3
    elif ( bmi >= 18.5 and bmi < 25):
        st.write("Acoording to your BMI, you are Healthy")
        clbmi=2
    elif ( bmi >= 25 and bmi < 30):
        st.write("Acoording to your BMI, you are Overweight")
        clbmi=1
    elif ( bmi >=30):
        st.write("Acoording to your BMI, you are Severely Overweight")
        clbmi=0
...
if __name__ == '__main__':
    ...
    veg = st.selectbox("Veg/Non Veg", options=[1, 0])
    ...
    if st.button('Weight Loss'):
        Weight_Loss(age, veg, weight, height)

    if st.button('Healthy'):
        Healthy(age, veg, weight, height)
